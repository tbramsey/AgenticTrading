...
def create_fundamentals_analyst(llm):
    def fundamentals_analyst_node(state) -> dict:
        ...
        sys_msg = (
            ...
            + " Use the available tools: `get_company_fundamentals` for comprehensive company analysis. Some tickers may not have data available; in such cases, explain that the data is unavailable due to API subscription limits."
        )
